...
public class Quote {
	...
	public Quote(String shopName, double price, DiscountCode code, Currency currency) {
	...
	public static Quote parse(String str) {
		...
		return new Quote(split[0], Double.parseDouble(split[1]), DiscountCode.valueOf(split[2]),
